...
\restrict AivG9qRTtPyvJpa9mWjPeUPb0YamArM03hgdvu7ZiHK8OjRC2TtbhakwwjmT2eM
...
ALTER TABLE ONLY public.user_daily_insights DROP CONSTRAINT user_daily_insights_user_id_fkey;
ALTER TABLE ONLY public.user_daily_comforts DROP CONSTRAINT user_daily_comforts_user_id_fkey;
ALTER TABLE ONLY public.user_daily_affirmations DROP CONSTRAINT user_daily_affirmations_user_id_fkey;
ALTER TABLE ONLY public.separations DROP CONSTRAINT separations_relationship_id_fkey;
ALTER TABLE ONLY public.separations DROP CONSTRAINT separations_partner_id_fkey;
ALTER TABLE ONLY public.separations DROP CONSTRAINT separations_creator_id_fkey;
ALTER TABLE ONLY public.relationships DROP CONSTRAINT relationships_user2_id_fkey;
ALTER TABLE ONLY public.relationships DROP CONSTRAINT relationships_user1_id_fkey;
ALTER TABLE ONLY public.reflection_sessions DROP CONSTRAINT reflection_sessions_user_id_fkey;
ALTER TABLE ONLY public.reflection_sessions DROP CONSTRAINT reflection_sessions_separation_id_fkey;
ALTER TABLE ONLY public.reflection_questions DROP CONSTRAINT reflection_questions_category_id_fkey;
ALTER TABLE ONLY public.reflection_comparisons DROP CONSTRAINT reflection_comparisons_user_b_session_id_fkey;
ALTER TABLE ONLY public.reflection_comparisons DROP CONSTRAINT reflection_comparisons_user_a_session_id_fkey;
ALTER TABLE ONLY public.reflection_comparisons DROP CONSTRAINT reflection_comparisons_separation_id_fkey;
ALTER TABLE ONLY public.reflection_answers DROP CONSTRAINT reflection_answers_user_id_fkey;
ALTER TABLE ONLY public.reflection_answers DROP CONSTRAINT reflection_answers_session_id_fkey;
ALTER TABLE ONLY public.reflection_answers DROP CONSTRAINT reflection_answers_question_id_fkey;
ALTER TABLE ONLY public.notifications DROP CONSTRAINT notifications_recipient_id_fkey;
ALTER TABLE ONLY public.moods DROP CONSTRAINT moods_user_id_fkey;
ALTER TABLE ONLY public.letters DROP CONSTRAINT letters_relationship_id_fkey;
ALTER TABLE ONLY public.letters DROP CONSTRAINT letters_partner_id_fkey;
ALTER TABLE ONLY public.letters DROP CONSTRAINT letters_author_id_fkey;
ALTER TABLE ONLY public.invite_codes DROP CONSTRAINT invite_codes_creator_id_fkey;
DROP INDEX public.ix_users_phone_number;
DROP INDEX public.ix_users_id;
DROP INDEX public.ix_user_daily_insights_user_id;
DROP INDEX public.ix_user_daily_insights_insight_date;
DROP INDEX public.ix_user_daily_insights_id;
DROP INDEX public.ix_user_daily_comforts_user_id;
DROP INDEX public.ix_user_daily_comforts_id;
DROP INDEX public.ix_user_daily_comforts_comfort_date;
DROP INDEX public.ix_user_daily_affirmations_user_id;
DROP INDEX public.ix_user_daily_affirmations_id;
DROP INDEX public.ix_user_daily_affirmations_affirmation_date;
DROP INDEX public.ix_separations_id;
DROP INDEX public.ix_relationships_id;
DROP INDEX public.ix_reflection_sessions_user_id;
DROP INDEX public.ix_reflection_sessions_separation_id;
DROP INDEX public.ix_reflection_sessions_id;
DROP INDEX public.ix_reflection_questions_id;
DROP INDEX public.ix_reflection_comparisons_id;
DROP INDEX public.ix_reflection_answers_id;
DROP INDEX public.ix_question_categories_id;
DROP INDEX public.ix_notifications_id;
DROP INDEX public.ix_moods_user_id;
DROP INDEX public.ix_moods_id;
DROP INDEX public.ix_letters_id;
DROP INDEX public.ix_invite_codes_id;
DROP INDEX public.ix_invite_codes_code;
DROP INDEX public.ix_apscheduler_jobs_next_run_time;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY public.user_daily_insights DROP CONSTRAINT user_daily_insights_pkey;
ALTER TABLE ONLY public.user_daily_comforts DROP CONSTRAINT user_daily_comforts_pkey;
ALTER TABLE ONLY public.user_daily_affirmations DROP CONSTRAINT user_daily_affirmations_pkey;
ALTER TABLE ONLY public.reflection_sessions DROP CONSTRAINT uq_user_day_sep;
ALTER TABLE ONLY public.user_daily_insights DROP CONSTRAINT uq_user_daily_insight;
ALTER TABLE ONLY public.user_daily_comforts DROP CONSTRAINT uq_user_daily_comfort;
ALTER TABLE ONLY public.user_daily_affirmations DROP CONSTRAINT uq_user_daily_affirmation;
ALTER TABLE ONLY public.reflection_comparisons DROP CONSTRAINT uq_sep_day;
ALTER TABLE ONLY public.separations DROP CONSTRAINT separations_pkey;
ALTER TABLE ONLY public.relationships DROP CONSTRAINT relationships_pkey;
ALTER TABLE ONLY public.reflection_sessions DROP CONSTRAINT reflection_sessions_pkey;
ALTER TABLE ONLY public.reflection_questions DROP CONSTRAINT reflection_questions_pkey;
ALTER TABLE ONLY public.reflection_questions DROP CONSTRAINT reflection_questions_day_number_key;
ALTER TABLE ONLY public.reflection_comparisons DROP CONSTRAINT reflection_comparisons_pkey;
ALTER TABLE ONLY public.reflection_answers DROP CONSTRAINT reflection_answers_pkey;
ALTER TABLE ONLY public.question_categories DROP CONSTRAINT question_categories_pkey;
...
ALTER TABLE ONLY public.invite_codes DROP CONSTRAINT invite_codes_pkey;
ALTER TABLE ONLY public.apscheduler_jobs DROP CONSTRAINT apscheduler_jobs_pkey;
ALTER TABLE ONLY public.alembic_version DROP CONSTRAINT alembic_version_pkc;
ALTER TABLE public.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.user_daily_insights ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.user_daily_comforts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.user_daily_affirmations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.separations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.relationships ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.reflection_sessions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.reflection_questions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.reflection_comparisons ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.reflection_answers ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.question_categories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.notifications ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.moods ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE public.user_daily_insights_id_seq;
DROP TABLE public.user_daily_insights;
DROP SEQUENCE public.user_daily_comforts_id_seq;
DROP TABLE public.user_daily_comforts;
DROP SEQUENCE public.user_daily_affirmations_id_seq;
DROP TABLE public.user_daily_affirmations;
DROP SEQUENCE public.separations_id_seq;
DROP TABLE public.separations;
DROP SEQUENCE public.relationships_id_seq;
DROP TABLE public.relationships;
DROP SEQUENCE public.reflection_sessions_id_seq;
DROP TABLE public.reflection_sessions;
DROP SEQUENCE public.reflection_questions_id_seq;
DROP TABLE public.reflection_questions;
DROP SEQUENCE public.reflection_comparisons_id_seq;
DROP TABLE public.reflection_comparisons;
DROP SEQUENCE public.reflection_answers_id_seq;
DROP TABLE public.reflection_answers;
DROP SEQUENCE public.question_categories_id_seq;
...
\unrestrict AivG9qRTtPyvJpa9mWjPeUPb0YamArM03hgdvu7ZiHK8OjRC2TtbhakwwjmT2eM
